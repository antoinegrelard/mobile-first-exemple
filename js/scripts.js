...
/*==========  Functions to add or remove a css class  ==========*/
...
function buildEvents() {
	var that = this;
	var btnPlay = document.querySelector('.video-button');
	btnPlay.addEventListener('click', function(e) {
		e.preventDefault();
		var popup = document.getElementById('popup');
		var video_link = this.dataset.video;
		addClass(popup, 'opened');
		addClass(document.body, 'popup-opened');
	...
	btnClose.addEventListener('click', function(e) {
		...
		removeClass(document.body, 'popup-opened');
	})
}
